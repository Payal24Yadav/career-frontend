...
export default function NewNewsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const toastId = toast.loading("Publishing news article...");
    try {
      const payload = {
        ...form,
        tags: form.tags
      ...
      toast.success("News article published successfully!", { id: toastId });
      router.push("/admin/news");
    } catch (err: any) {
      toast.error(err.response?.data?.message || "Failed to publish news article", { id: toastId });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="pb-20">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-navy flex items-center gap-2">
          <Bell className="w-6 h-6 text-primary" /> Add New News Article
        </h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-6 shadow-sm">
          <div className="flex items-center justify-between border-b border-gray-100 pb-3">
            ...
            <span className="text-xs text-gray-400">Add dynamic, styled content sections.</span>
          </div>
        ...
        {/* Metadata, Author, Categories, Toggles */}
        <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-6 shadow-sm">
        ...
        <div className="flex justify-end gap-4">
          ...
          >
            <Save className="w-5 h-5" /> {loading ? "Publishing..." : "Publish Update"}
          </button>
        </div>
      </form>
    </div>
